...
static int OpenLog()
{
    ...
    strcpy(caLogName,"/home/dcsp/moniXpep/chexiao.log");
    ...
    //printf("OpenLog caLogName=%s \n",caLogName);
    
    return dcs_log_open(caLogName, "moniXpep");
}
...
int main(int argc, char *argv[])
{
	...
	setbit(&siso,4,(unsigned char *)"000000009999", 12);
	...
	setbit(&siso,25,(unsigned char *)"14", 2);
